...
const getStarshipsDetail = (url: string, cb: any) => {
	handleRequest(url, cb);
};

const getStarshipsDetailItemList = (array: string[] | undefined, cb: any) => {
	if (array) {
		const requests: any = [];
...
export { getStarshipsDetail, getStarshipsDetailItemList };
